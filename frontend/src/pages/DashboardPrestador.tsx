...
const styles: Record<string, React.CSSProperties> = {
  ...
  topBanner: {
    ...
    padding: '32px 40px', boxShadow: 'var(--shadow-sm)', color: 'var(--brand-900)', border: '1px solid rgba(255,255,255,0.8)',
  },
  topBannerInner: { display: 'flex', alignItems: 'center', gap: '24px', flexWrap: 'wrap' },
  avatarRing: { padding: '4px', borderRadius: '50%', background: 'var(--brand-100)', flexShrink: 0 },
  avatar: {
    width: '68px', height: '68px', borderRadius: '50%',
    background: 'var(--gradient-neon)', border: '2px solid white',
  ...
  panelLabel: { fontSize: '11px', fontWeight: '800', color: 'var(--brand-600)', textTransform: 'uppercase', letterSpacing: '1px' },
  businessTitle: { fontSize: '26px', fontWeight: '800', color: 'var(--brand-900)', letterSpacing: '-0.5px' },
  bannerTagRow: { display: 'flex', gap: '8px', flexWrap: 'wrap' },
  categoryTag: {
    fontSize: '11px', fontWeight: '700', backgroundColor: 'var(--brand-50)',
    border: '1px solid var(--brand-200)', color: 'var(--brand-700)', padding: '3px 10px',
    borderRadius: 'var(--radius-full)', letterSpacing: '0.5px',
  },
  statusBadge: {
    fontSize: '11px', fontWeight: '700', backgroundColor: 'var(--success-bg)',
    border: '1px solid rgba(16,185,129,0.3)', color: 'var(--success-text)', padding: '3px 10px',
  ...
  card: { backgroundColor: 'rgba(255, 255, 255, 0.85)', backdropFilter: 'blur(12px)', borderRadius: 'var(--radius-lg)', border: '1px solid rgba(255, 255, 255, 0.5)', padding: '32px', boxShadow: 'var(--shadow-sm)' },
  cardTitle: {
